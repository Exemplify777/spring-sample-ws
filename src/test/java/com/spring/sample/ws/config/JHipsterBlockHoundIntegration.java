...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.spring.sample.ws.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.spring.sample.ws.security.DomainUserDetailsService", "createSpringSecurityUser");
