...
import static com.spring.sample.ws.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static com.spring.sample.ws.test.util.OAuth2TestUtil.authenticationToken;
import static com.spring.sample.ws.test.util.OAuth2TestUtil.registerAuthenticationToken;
